...
func _draw():
	...
	for i in range(0, owner.SHADOW_RESOLUTION):
		...
		hidden_colors.append(owner.hidden_colour)
		hidden_colors.append(owner.hidden_colour.linear_interpolate(Color(owner.hidden_colour.r, owner.hidden_colour.g, owner.hidden_colour.b, 0.0), power_a))
		hidden_colors.append(owner.hidden_colour.linear_interpolate(Color(owner.hidden_colour.r, owner.hidden_colour.g, owner.hidden_colour.b, 0.0), power_b))
